...
def makeMessageStruct(file, className, Message, indent=4):
    messageName = getMessageName(Message, withUBX=False, withMessageClass=False)
...
def generateCPP_main():
    ...
    for Cls in getClassesInModule(UBX):
        ...
        fileName = cppsrcdir.joinpath("messages", className+".h")
    ...
    # make parseUBX.h
    fNames = list()
    fileName = cppsrcdir.joinpath("parseUBX.h")
    shortName = fileName.relative_to(topdir)  # Starts with lang/cpp...
    file = open(fileName, 'w')
    file.write("// File {}\n".format(shortName))
    file.write("// Auto-generated by pyUBX {} v{} on {}\n".format(
