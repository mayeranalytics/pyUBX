#ifndef __PARSEUBXBASE_H__
#define __PARSEUBXBASE_H__
...
ParseUBXBase::parse(uint8_t c)
{
    ...
    case UBX_LEN_2:
        ...
        if(UBX_payload_len==0)
            ...
            #ifdef DEBUG
            printf("ParseUBXBase::BUFLEN exceeded while parsing UBX message\n");
            #endif
...
void
ParseUBXBase::UBX_update_ck(char c)
{
    UBX_ck_a_calculated += c;
    UBX_ck_b_calculated += UBX_ck_a_calculated;
}

#endif /* #ifndef __PARSEUBXBASE_H__ */
