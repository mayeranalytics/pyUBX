...
// Auto-generated by pyUBX generateCPP.py v0.1 on 2017-11-11T12:57:56.107793
    ...
    void onUBX(uint8_t cls, uint8_t id, size_t len, char buf[]) {
        ...
        case 0x06: // Message class CFG
            ...
            case 0x00: // Message CFG-PRT
                ...
                break;
            case 0x00: // Message CFG-PRT_GET
                onCFG_PRT_GET(*((CFG::PRT_GET*)buf), len);
                break;
...
public:
    ...
    /* callback for CFG::PRT_GET messages */
    virtual void onCFG_PRT_GET(CFG::PRT_GET& msg, size_t len) {}
